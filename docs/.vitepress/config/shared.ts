...
export const shared = defineConfig({
  ...
  cleanUrls: true,
  title: "MMRL",
  description: "MMRL - A decentralized ecosystem for sharing, distributing, and discovering Magisk modules. Comprehensive root manager support for Magisk, KernelSU, and APatch.",
  sitemap: {
  ...
  head: [
    ...
    // SEO Meta Tags
    ["meta", { name: "keywords", content: "MMRL, Magisk modules, KernelSU, APatch, Android root, module repository, Magisk Module Repo Loader, module management" }],
    ...
    ["meta", { property: "og:description", content: "A decentralized ecosystem for sharing, distributing, and discovering Magisk modules with comprehensive root manager support." }],
    ...
    ["meta", { name: "twitter:description", content: "A decentralized ecosystem for sharing, distributing, and discovering Magisk modules with comprehensive root manager support." }],
  ...
  transformHead({ pageData }) {
    ...
    return [
      ...
      ['meta', { property: 'og:description', content: pageData.description || pageData.frontmatter?.description || "MMRL - Magisk Module Repo Loader" }],
    ];
  },
